...
class signupModel extends Model {
    ...
    public function setSignupUser($gebruikersnaam, $voornaam, $tussenvoegsel, $achternaam, $adresregel_1, $adresregel_2, $postcode, $plaatsnaam, $land_id, $geboortedatum, $telefoon, $mailbox, $hashedPwd, $vraag, $antwoordtekst) {
        $sql = "INSERT INTO Gebruiker (gebruikersnaam, voornaam, tussenvoegsel, achternaam, adresregel_1, adresregel_2, postcode, plaatsnaam, land_id, geboortedatum, telefoon, mailbox, wachtwoord, vraag, antwoordtekst, is_verkoper) 
                VALUES (:gebruikersnaam, :voornaam, :tussenvoegsel, :achternaam, :adresregel_1, :adresregel_2, :postcode, :plaatsnaam, :land_id, :geboortedatum, :telefoon, :mailbox, :hashedPwd, :vraag, :antwoordtekst, 0)";
        $req = Database::getBdd()->prepare($sql);
