        ...
        if (isset($_POST['signup_submit'])) {
            ...
            if (!isset($_POST['gebruikersnaam']) || !isset($_POST['voornaam']) || !isset($_POST['achternaam']) || !isset($_POST['adres_1']) || !isset($_POST['postcode']) || !isset($_POST['plaatsnaam']) || !isset($_POST['geboortedatum']) || !isset($_POST['telefoonnummer']) || !isset($_POST['mailbox']) || !isset($_POST['wachtwoord']) || !isset($_POST['wachtwoord_bevestigen']) || !isset($_POST['beveiligingsvraag']) || !isset($_POST['antwoordtekst'])) {
                ...
                if (empty($resultArray)) { //al in database check
                    ...
                    $registratieModel->setSignupUser($_POST['gebruikersnaam'], $_POST['voornaam'], $_POST['tussenvoegsel'], $_POST['achternaam'], $_POST['adres_1'], $_POST['adres_2'], $_POST['postcode'], $_POST['plaatsnaam'], $land_id, $_POST['geboortedatum'], $_POST['telefoonnummer'], $_POST['mailbox'], $hashedPwd, $_POST['beveiligingsvraag'], $_POST['antwoordtekst'], $rating, $vkey);
