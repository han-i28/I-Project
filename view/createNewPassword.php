...
<div class="container uk-position-center">
    ...
    <form action="" method="post" class="uk-form uk-width-1-1 uk-margin-large">
        ...
        <button class="uk-button uk-button-primary" type="submit" name="reset-password-submit">Reset Wachtwoord</button>
    </form>
